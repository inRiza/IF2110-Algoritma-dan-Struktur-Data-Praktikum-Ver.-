...
/* Menghasilkan kuadran ari P: 1, 2, 3, atau 4 */
...
{
    POINT hasil;
    CreatePoint(&hasil, Absis(P) + 1, Ordinat(P));
    return hasil;
}
...
{
    POINT hasil;
    CreatePoint(&hasil, Absis(P), Ordinat(P) + 1);
    return hasil;
}
...
{
    POINT hasil;
    CreatePoint(&hasil, Absis(P) + deltaX, Ordinat(P) + deltaY);
    return hasil;
}
...
POINT MirrorOf(POINT P, boolean SbX)
{
    ...
    if (SbX)
    {
        CreatePoint(&hasil, -Absis(P), Ordinat(P));
    }
    else
    {
        return CreatePoint(&hasil, Absis(P), -Ordinat(P));
    }
}
